...
$nomeSolicitante = $_SESSION['nomeSolicitante'];
...
<body>
    <div class="confirmation-container">
        ...
        <h1>Solicitante:</h1>
        <p><?php echo htmlspecialchars($nomeSolicitante); ?></p>

        <h1>Paciente:</h1>
        <p><?php echo htmlspecialchars($nomePaciente); ?></p>

        <div class="protocolo-info">
            <h1>Número de Protocolo:</h1>
            <p><?php echo htmlspecialchars($protocolo); ?></p>
