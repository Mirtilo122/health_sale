<div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                            ...
                            <td scope="row" class="align-middle text-center">
                                ...
                                @elseif($status == 'Atribuido')
                                    @php
                                        $id = session('id');
                                    @endphp
                                    @if($id == $solicitacao->id_usuario)
                                        <span class="badge bg-secondary text-light">Atribuída a Você</span>
                                    @else
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center">Nenhuma solicitação marcada como favorita encontrada.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
