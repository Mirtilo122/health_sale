            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="align-middle text-center">
                            <a href="{{ route('dashboard.order', ['order_by' => 'data_liberacao', 'direction' => request()->direction == 'asc' ? 'desc' : 'asc']) }}"
                            class="sortable {{ request()->order_by == 'data_liberacao' ? (request()->direction == 'asc' ? 'active-asc' : 'active-desc') : '' }}">
                            Tempo
                            </a>
                        </th>
                ...
                <tbody>
                    @forelse ($solicitacoes->where('status', 'liberacao') as $solicitacao)
                        @php
