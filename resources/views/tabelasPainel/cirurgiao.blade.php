<div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    @forelse ($solicitacoes->where('status', 'cirurgiao') as $solicitacao)
                        <tr>
                        ...
                        <a href="#" onclick="toggleFavorite(event, {{ $solicitacao->codigo_solicitacao }})">
                            ...
                            <td scope="row" class="align-middle text-center
                                @php
                                    $diferencaMinutos = \Carbon\Carbon::parse($solicitacao->data_cirurgiao)->diffInMinutes(now());
                                    $classeTexto = '';
                                ...
                                @endphp
                                {{ $classeTexto }}"                            >
                                {{ \Carbon\Carbon::parse($solicitacao->data_cirurgiao)->diffForHumans() }}
                            </td>
                            <td scope="row" class="align-middle text-center">
