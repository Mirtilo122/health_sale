...
<div class="row mt-1 d-flex">
    ...
    <div class="col-md-4 border-end border-grey">
        ...
        <div id="comorbidade" class="{{ $dados->comorbidades === 'sim' ? '' : 'd-none' }}">
            ...
            <textarea id="descComorbidades" name="descricao_comorbidades" rows="4" value="{{$dados->descricao_comorbidades}}"></textarea>
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="select_alterar">
        <input type="hidden" id="solicitanteHidden" name="solicitante" value="{{ $dados->solicitante }}">
        <select id="solicitante" name="solicitanteOrcamento" onchange="atualizarHidden('solicitante')" disabled>
            <option value="paciente" @selected($dados->solicitante === "paciente")>Paciente ou Representante</option>
            <option value="medico" @selected($dados->solicitante === "medico")>Médico</option>
        </select>
