            ...
            <div class="col-10 flex-fill">
                ...
                <div class="row d-flex mb-2">
                    <div class="col-9 flex-fill">
                        <h4 class="mt-2">
                        Total: R$ <span id="totalValor">{{ !empty($orcamento) && isset($orcamento->valor_total) ? number_format($orcamento->valor_total, 2, ',', '.') : '00,00' }}</span>
                        </h4>
                        <input type="hidden" name="valor_total" id="valor_total"
                        value="{{ !empty($orcamento) && isset($orcamento->valor_total) ? number_format($orcamento->valor_total, 2, '.', '') : '0.00' }}"
                        >
                    </div>
